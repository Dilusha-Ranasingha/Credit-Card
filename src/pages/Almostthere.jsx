...
//                   />
//                   <div className="flex items-center justify-between px-4 py-3 border border-gray-300 rounded-lg hover:border-red-400 hover:bg-red-50 transition-colors cursor-pointer bg-gray-50">
...
//                     type="text"
//                     placeholder="Code*"
//                     className="w-full max-w-md px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
//                   />
//                 </div>
...
//                     placeholder="Remarks*"
//                     rows="4"
//                     className="w-full max-w-md px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent resize-none"
//                   />
//                 </div>
//               </div>
//             </div>
