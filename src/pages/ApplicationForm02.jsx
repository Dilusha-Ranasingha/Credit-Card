...
const ApplicationForm02 = () => {
  ...
  const handlePrevious = () => {
    console.log("Navigating to ApplicationForm01.jsx");
  };
  ...
  return (
    <div className="bg-gradient-to-br from-red-100 to-blue-100 min-h-screen py-12 px-4 flex justify-center items-center">
      <div className="bg-white rounded-xl shadow-xl p-10 w-full max-w-4xl space-y-8">
        ...
        <h2 className="text-2xl font-bold text-red-700 text-center mb-4">Let's stay in touch</h2>
...
export default ApplicationForm02;